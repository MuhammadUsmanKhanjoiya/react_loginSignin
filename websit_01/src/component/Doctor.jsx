  ...
  return (
    <div>
      ...
      {doctors.map((doctor, index) => (
        <div key={index} className="doctor-card p-6  border-red-200 border-2  rounded-lg shadow-lg bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
          <h2 className="text-2xl font-bold bg-gradient-to-r text-transparent from-red-500 to-red-400 bg-clip-text mb-2 ">{doctor.name}</h2>
          ...
          <p className="text-gray-600 mb-1"><strong>Clinic Hours:</strong> {doctor.timing}</p>
