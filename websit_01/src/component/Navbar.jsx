    ...
    <div className="w-full mb-10">
      ...
      <nav className="navbar navbar-dark text-lg flex items-center justify-between font-medium bg-gradient-to-r from-red-500 to-red-400 hover:to-red-500 hover:from-red-400 w-full px-3 py-2 text-white fixed top-0 sm:hidden">
        <div className="container-fluid flex justify-between items-center">
          <h1 className="text-white text-base whitespace-nowrap">Free Blood Bank</h1>
          <button
      ...
      <div className="hidden sm:flex w-full text-lg items-center justify-between font-medium bg-gradient-to-r from-red-700 to-red-500 hover:to-red-700 hover:from-red-500 px-6 py-3 text-white">
        <h1 className="text-2xl text-white font-serif whitespace-nowrap">Free Blood Bank</h1>
        <div className="font-thin text-lg space-x-4">
          <Link to={"/home"} className="whitespace-nowrap">Home</Link>
          <Link to={"/information"} className="whitespace-nowrap">Information</Link>
          <Link to={"/dataInfo"} className="whitespace-nowrap">DataInfo</Link>
          <Link to={"/doctor"} className="whitespace-nowrap">Doctor</Link>
        </div>
        <button className="py-1 px-2 bg-white text-red-700 rounded" onClick={handleLogout}>
          Logout
        </button>
      </div>
    </div>
