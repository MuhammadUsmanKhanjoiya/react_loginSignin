  ...
  return (
    ...
    <div className="p-10  bg-gradient-to-r from-red-700 to-red-500 hover:to-red-700 hover:from-red-500">
      ...
      <div className="bg-gray-100 rounded-md p-10 w-5/6 my-0 mx-auto">
         <h1 className="bg-gradient-to-r mb-2  text-transparent from-red-700 to-red-400 bg-clip-text text-3xl font-bold text-center">Add your details</h1>
        <p className="text-center text-gray-500 text-base font-medium mb-3">your some imformation save someone life in difficuilt time</p>
